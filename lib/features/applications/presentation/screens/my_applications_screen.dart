...
class _StudentInterviewCard
    extends StatelessWidget {
  final ApplicationModel application;

  const _StudentInterviewCard({
    required this.application,
  });
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          _InterviewDetailRow(
            icon: application.interviewMode ==
                    'In-person'
                ? Icons
